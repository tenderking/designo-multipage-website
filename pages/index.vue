<template>
  <main>
    ...
    <div class="card-wrapper">
      <CardDarkItem v-for="project in projects" :destination="project.destination" :imgUrl="project.imgUrl"
        :title="project.title">
        {{ project.title }}
      </CardDarkItem>
    </div>
    <div class="feature-wrapper">
      <FeatureItem v-for="feature in features" :imgUrl="feature.imgUrl">
        <template #title>
          {{ feature.title }}
        </template>
        <template #body>
